...
public class RecipeLab {
    ...
    //private static final RecipeLab ourInstance = new RecipeLab();
    //private static DatabaseReference mDatabase = FirebaseDatabase.getInstance().getReference();
    private static DatabaseReference mDatabase;
    private static FirebaseUser mFirebaseUser;
    //private static final FirebaseUser mFirebaseUser = FirebaseAuth.getInstance().getCurrentUser();

    public static RecipeLab getInstance() {
        System.out.println("RECIPELAB: RecipeLab getInstance called");
        if (sRecipeLab == null){
    ...
    private RecipeLab() {
        System.out.println("RECIPELAB: made new RecipeLab()");
    ...
    public void addRecipe(Recipe recipe) {
        ...
        r.setImages(recipe.getImages());
        r.setRating(recipe.getRating());
        r.setRecipeName(recipe.getRecipeName());
        r.setSourceName(recipe.getSourceName());
        r.setSourceUrl(recipe.getSourceUrl());
        r.setLargeImageUrl(recipe.getLargeImageUrl());
    ...
    //TODO: recipe loskoppelen van user in database (zodat er ook weer unsubscribed kan worden)
}
